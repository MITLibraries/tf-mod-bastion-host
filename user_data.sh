...
#Install Logz.io monitoring of rsyslog
sudo curl -sLO https://github.com/logzio/logzio-shipper/raw/master/dist/logzio-rsyslog.tar.gz && tar xzf logzio-rsyslog.tar.gz && sudo rsyslog/install.sh -t linux -a ""${logzio_token}"" -l "listener.logz.io"
